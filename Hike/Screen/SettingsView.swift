    ...
    var body: some View {
        ...
        List {
            ...
            Section(
                ...
                CustomListRowView(rowIcon: "ellipsis.curlybraces", rowLabel: "Developer", rowContent: "Ayoub Benderdouch", rowTintColor: .mint)
                
                CustomListRowView(rowIcon: "paintpalette", rowLabel: "Designer", rowContent: "Ayoub Benderdouch", rowTintColor: .pink)
                
                CustomListRowView(rowIcon: "globe", rowLabel: "Github", rowTintColor: .indigo, rowLinkLabel: "AyoubBenderdouch", rowLinkDestination: "https://github.com/Saamu02"
                )
            }
        }
    }
